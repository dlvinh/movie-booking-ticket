          ...
          <form onClick={handleSubmit}>
            ...
            <div className="mt-8">
              <div>
                ...
                <input onChange={handleChange} name="phone" className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="number" placeholder="0412345678" />
                {errors?.phone ? <div id="feedback" className='text-red-600 text-sm'>{errors.phone}</div> : ""}
              </div>
            </div>
            {/* Ho ten */}
            <div className='mt-8'>
            ...
            <div className="mt-10">
              <button className="bg-indigo-500 w-full text-gray-100 p-4 rounded-full tracking-wide
